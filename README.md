...
3. If you are calling Iterable SDK from Swift, all you need to do is inherit from ITBNotificationServiceExtension. If you are using Objective-C, you will have to delegate to the implementation provided. 
