...
final class IterableAPIInternal: NSObject, PushTrackerProtocol, AuthProvider {
    ...
    func trackInAppClose(_ message: IterableInAppMessage, location: InAppLocation = .inApp, source: InAppCloseSource = .unknown, clickedUrl: String? = nil) {
    ...
    func inAppConsume(message: IterableInAppMessage, location: InAppLocation = .inApp, source: InAppDeleteSource = .unknown) {
