...
class IterableAPITests: XCTestCase {
    ...
    func testTrackEventWithNoEmailOrUser() {
        ...
        TestHelper.initializeApi(apiKey: IterableAPITests.apiKey, networkSession: networkSession)
    ...
    func testRegisterTokenNilEmailAndUserId() {
        ...
        TestHelper.initializeApi(apiKey: IterableAPITests.apiKey, config:config, networkSession: networkSession)
        IterableAPI.email = nil
        IterableAPI.userId = nil
    ...
    func testInitializeWithLaunchOptionsAndCustomAction() {
        ...
        TestHelper.initializeApi(apiKey: IterableAPITests.apiKey,
