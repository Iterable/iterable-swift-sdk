...
class IterableAPITests: XCTestCase {
    ...
    func testRegisterTokenNilAppName() {
        ...
        IterableAPI.register(token: "zeeToken".data(using: .utf8)!, onSuccess: { _ in
    ...
    func testTrackPurchaseNoUserIdOrEmail() {
        ...
        IterableAPI.track(purchase: 10.0, items: [], dataFields: nil, onSuccess: { _ in
    ...
    func testTrackPurchaseWithUserId() {
        ...
        IterableAPI.track(purchase: 10.55, items: [], dataFields: nil, onSuccess: { _ in
            let body = networkSession.getRequestBody() as! [String: Any]
    ...
    func testTrackPurchaseWithEmail() {
        ...
        IterableAPI.track(purchase: total, items: items, dataFields: nil, onSuccess: { _ in
            let body = networkSession.getRequestBody() as! [String: Any]
