...
xcodebuild archive -scheme "swift-sdk" -archivePath SKIP_INSTALL=NO BUILD_LIBRARY_FOR_DISTRIBUTION=YES "./${OUTPUT_FOLDER}/IterableSDK-iOS" -sdk iphoneos

# -destination="iOS Simulator" -- seems like "-sdk iphonesimulator" is needed and not this?
xcodebuild archive -scheme "swift-sdk" -archivePath SKIP_INSTALL=NO BUILD_LIBRARY_FOR_DISTRIBUTION=YES "./${OUTPUT_FOLDER}/IterableSDK-Simulator" -sdk iphonesimulator
